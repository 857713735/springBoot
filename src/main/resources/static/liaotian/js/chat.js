...
$(document).ready(function() {
    function e() {
        function h() { - 1 != g.indexOf("*#emo_") && (g = g.replace("*#", "<img src='liaotian/img/").replace("#*", ".gif'/>"), h())
        }
        var e = new Date,
            f = "";
        f += e.getFullYear() + "-",
    ...
    var a = 3,
        b = "liaotian/img/head/2024.jpg",
        c = "liaotian/img/head/2015.jpg",
        d = "\u738b\u65ed";
    $(".close_btn").click(function() {
        ...
        $(".chat03_content li").dblclick(function() {
            var b = $(this).index() + 1;
            a = b,
                c = "liaotian/img/head/20" + (12 + a) + ".jpg",
